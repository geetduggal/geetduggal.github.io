...
### Why Ledger Didn’t Stick

Plain text accounting with Ledger appealed to the same part of me that loves plain text notes. But it was ultimately too complicated and hard to maintain. I found myself falling behind, then dreading the catch up sessions, then abandoning the system entirely.

These days I use Monarch Money. It connects to my accounts, categorizes transactions automatically, and gives me the visibility I need without the manual overhead. I haven’t given up on plain text finance entirely though. Monarch exports to CSV, and I’m curious about building a workflow that periodically pulls my data into a plain text format for archival and analysis.
...
### Why CSV for Projects Didn’t Stick

I wrote about using CSV files for project management as a plain text alternative to complex task managers. Really nice idea in theory, but I found Obsidian Kanban simpler and more useful in practice. A few H2 headers with bulleted lists gives me the same visibility with less friction.
...
### Why Digital Doodles and Working Memory Stuck

I still find myself thinking in groups of three to six items. There’s something about that cognitive chunk size that matches how my brain works.

The practice: dump items quickly into my Log or Working Memory section, then process them. This gives me confidence I haven’t missed anything and helps me work on related things together. It’s like a mental clipboard that persists across interruptions.
...
Readwise and Readwise Reader might be the best apps I’ve ever used. They serve a thoughtful purpose: capturing highlights from books, articles, and podcasts, then resurfacing them over time.

What makes it stick is the seamless sync with my plain text vault. My highlights automatically appear in Obsidian, work beautifully with Obsidian Bases for querying, and I always have a version backed up in plain text.
